...
DEFINE_DEVICE_TYPE(FLOPPY_8_SSSD32, floppy_8_sssd32, "floppy_8_sssd32", "8\" single-sided single density 32 hard sector floppy drive")
...
//-------------------------------------------------
//  8" single-sided single density 32 hard sector
//-------------------------------------------------

floppy_8_sssd32::floppy_8_sssd32(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	floppy_image_device(mconfig, FLOPPY_8_SSSD32, tag, owner, clock)
{
}

floppy_8_sssd32::~floppy_8_sssd32()
{
}

void floppy_8_sssd32::setup_characteristics()
{
	form_factor = floppy_image::FF_8;
	tracks = 77;
	sides = 1;
	...
	variants.push_back(floppy_image::SSSD32);
}
