...
{
	m_reset=asserted;
	if (asserted) { stop_read(); m_local[0]=m_local[1]=false; m_motion=false; m_settle=0; m_timer->adjust(attotime::never); m_irq={}; m_active_type=0; m_index=false; m_latches={}; m_end_status=0; }
}
